...
class FunkinLua {
	...
	public function new(script:String) {
		...
		Lua_helper.add_callback(lua, "addGlitchEffect", function(camera:String,waveSpeed:Float = 0.1,waveFrq:Float = 0.1,waveAmp:Float = 0.1) {	// os engine shit
		...
		// deprecated shaders
			...
			Lua_helper.add_callback(lua, "addScanlineEffect", function(camera:String,lockAlpha:Bool=false) {
				luaTrace('addScanlineEffect is deprecated in favor of Runtime Shaders!', false, true);
			...
			Lua_helper.add_callback(lua, "addGrainEffect", function(camera:String,grainSize:Float,lumAmount:Float,lockAlpha:Bool=false) {
				luaTrace('addGrainEffect is deprecated in favor of Runtime Shaders!', false, true);
			...
			Lua_helper.add_callback(lua, "addTiltshiftEffect", function(camera:String,blurAmount:Float,center:Float) {
				luaTrace('addTiltshiftEffect is deprecated in favor of Runtime Shaders!', false, true);
			...
			Lua_helper.add_callback(lua, "addVCREffect", function(camera:String,glitchFactor:Float = 0.0,distortion:Bool=true,perspectiveOn:Bool=true,vignetteMoving:Bool=true) {
				luaTrace('addVCREffect is deprecated in favor of Runtime Shaders!', false, true);
